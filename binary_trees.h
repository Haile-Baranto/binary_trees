...
/* All header files from standard library */
	#include <stdio.h>
	#include <stdlib.h>
	#include <stddef.h>

/*Different structs used to create binary tree data structure*/
/**
...
{
	const binary_tree_t *node; /**< A pointer to a binary tree node. */
